                                    ...
                                    <div class="d-flex align-items-center justify-content-between m-b-30">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a href="<?=base_url('participants')?>"><button class="btn btn-secondary btn-xs active" data-toggle="tooltip" data-placement="top" title="Participants List"><i class="anticon anticon-bars"></i></button></a>
                                                <a href="<?=base_url('participants/attendance')?>"><button class="btn btn-secondary btn-xs" data-toggle="tooltip" data-placement="top" title="Attendance List"><i class="anticon anticon-barcode"></i></button></a>
                                            </div>
